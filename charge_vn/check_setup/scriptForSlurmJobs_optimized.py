...
# ==============================================================================
#---For qn quantiles ---
#STEP="Charge_Quantiles"
#DATE_tag= "Jun11_ForCheck" # include version here!!
#DATASET= "MB0to1"
#SOURCE_CODE_NAME="make_q2_slices_PbPb2023.C"

#--- Resolution ---
#STEP="Charge_Resolution"
#DATASET= "MB0to1"
#DATE_tag= "Jun11_ForCheck" # include version here!!
...
STEP="Charge_Flow"
DATASET= "MB0to1"
DATE_tag= "June15_ForCheck_v2" # include version here!!
...
INPUT_FLIST = f"{CMSSW_DIR}/charge_vn/check_setup/inputFiles_charge_MB0to1.txt"
