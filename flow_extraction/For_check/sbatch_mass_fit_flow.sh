...
SRC="/home/saha115/D0_ESE/CMSSW_13_2_11/src/flow_extraction/For_check/fit_mass_and_flow.C"
SRC_DIR="$(dirname "$SRC")"

SCRATCH_BASE="${SCRATCH_BASE:-/scratch/negishi/saha115/D0_ESE_out/CMSSW_13_2_11/src/Flow_output_FullStat_Run2Comparison_May22_v0}"
