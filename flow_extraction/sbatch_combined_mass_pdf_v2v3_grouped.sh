...
# --- CONFIGURATION ---
PLOT_SOURCE_DIR="/scratch/negishi/saha115/D0_ESE_out/CMSSW_13_2_11/src/Flow_output_FullStat_May19_v1/output/prompt_mass_plot_withchi2_sigma"
GRID_V2="7x6"   # 7 cols x 6 rows = 42 = N_VBINS_V2 (one page per group)
GRID_V3="8x6"   # 8 cols x 6 rows = 48 = N_VBINS_V3 (one page per group)
FINAL_OUTPUT_V2="All_Plots_Combined_v2_FullStat_May19_v3.pdf"
FINAL_OUTPUT_V3="All_Plots_Combined_v3_FullStat_May19_v3.pdf"
