...
##SBATCH --output=/scratch/negishi/saha115/D0_ESE_out/CMSSW_13_2_11/src/save_vnbinning_outputs_PubRes_Mar8_v2/logs/slurm_%A_%a.out
##SBATCH --error=/scratch/negishi/saha115/D0_ESE_out/CMSSW_13_2_11/src/save_vnbinning_outputs_PubRes_Mar8_v2/logs/slurm_%A_%a.err
set -euo pipefail

SRC="/home/saha115/D0_ESE/CMSSW_13_2_11/src/Compare_PubResults/save_vnbinning_to_txt.C"
SCRATCH_BASE="${SCRATCH_BASE:-/scratch/negishi/saha115/D0_ESE_out/CMSSW_13_2_11/src/save_vnbinning_outputs_PubRes_Mar9_v0}"
...
# map array index (0..35) -> centrality (0..2) and pT (0..11)
CENT_IDX=$(( TASK_ID / 12 ))
PT_IDX=$(( TASK_ID % 12 ))
