...
void Calculate_Resolution_latest(TString input_txt, TString output_path, int istart, int iend) {
...
int main(int argc, char *argv[])
{
...

    {
        ...
        Calculate_Resolution_latest(input_txt, output_path, istart, iend);
    }
    else
    {
