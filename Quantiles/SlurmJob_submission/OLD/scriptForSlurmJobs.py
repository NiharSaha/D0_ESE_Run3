...
class jobs_submission():
    ...
    def build_job_files(self, job_name):
        ...
        with open(subfile, "w") as fsub:
            ...
            fsub.write(f'./DMass_out.exe {self.flist_name} {self.base_dir} {self.istart} {self.iend} \n')
            fsub.close()
    ...
    def submit_jobs(self, base_dir, njobs, nfile_per_job, dry_run=False):
        ...
        for i in range(njobs):
            ...
            job_name = f"DMass_out_{self.istart}_{self.iend}"
...
if __name__ == "__main__":
    ...
    base_dir = "/scratch/bell/saha115/D0_RAA_new/ROOT/CMSSW_13_2_11/src/Jun28_1030/"
    flist_name = "/home/saha115/Purdue/CMSSW_13_2_11/src/PbPb_files_new.txt"
